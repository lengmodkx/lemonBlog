        ...
        <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-12">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl mb-8">
              A Java backend developer who enjoys programming, reading, and sharing knowledge.
              This blog is where I document my learning, thoughts, and side projects.
            </p>
        ...
        <div className="max-w-5xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-12">
            <div className="flex gap-8 md:gap-12">
              <StatItem value={String(allPosts.length)} label="Posts" />
              <StatItem value={String(projects.length)} label="Projects" />
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="text-muted-foreground max-w-md">
                Interested in my posts or projects? Feel free to reach out via email.
              </p>
            </div>
            <a
